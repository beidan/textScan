				...
				if (r > d - n && c + n > r && l > p - n && m + n > l || r > d - n && c + n > r && h > p - n && m + n > h || o > d - n && c + n > o && l > p - n && m + n > l || o > d - n && c + n > o && h > p - n && m + n > h) {
					if ("inner" != s.snapMode) {
						...
						f && (i.position.top = a._convertPositionTo("relative", {
							...
							top: m,
							left: 0
						}).top - a.margins.top), v && (i.position.left = a._convertPositionTo("relative", {
							top: 0,
							left: d - a.helperProportions.width
						}).left - a.margins.left), y && (i.position.left = a._convertPositionTo("relative", {
							top: 0,
							left: c
						}).left - a.margins.left)
					}
		...
		t._create = function() {
			if (this.options.navigation) {
				var t = this,
					...
					s = a.next(),
					n = a.add(s).find("a").filter(this.options.navigationFilter)[0];
	...
	$.extend(Datepicker.prototype, {
		...
		_generateHTML: function(e) {
			...
			var x = e.inline ? "" : '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">' + this._get(e, "closeText") + "</button>",
				D = a ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (i ? x : "") + (this._isInRange(e, k) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + _ + "</button>" : "") + (i ? "" : x) + "</div>" : "",
			...
			for (var F = this._getDefaultDate(e), j = "", H = 0; r[0] > H; H++) {
				...
				for (var z = 0; r[1] > z; z++) {
					...
					var B = (this._getFirstDayOfMonth(m, p) - w + 7) % 7,
						K = Math.ceil((B + Q) / 7),
...
(function(e) {
	e.effects.effect.bounce = function(t, i) {
		...
		for ((u || h) && o.push("opacity"), e.effects.save(r, o), r.show(), e.effects.createWrapper(r), c || (c = r["top" === v ? "outerHeight" : "outerWidth"]() / 3), u && (n = {
			opacity: 1
		}, n[v] = 0, r.css("opacity", 0).css(v, y ? 2 * -c : 2 * c).animate(n, f, g)), h && (c /= Math.pow(2, p - 1)), n = {}, n[v] = 0, a = 0; p > a; a++) s = {}, s[v] = (y ? "-=" : "+=") + c, r.animate(s, f, g).animate(n, f, g), c = h ? 2 * c : c / 2;
		h && (s = {
			opacity: 0
		}, s[v] = (y ? "-=" : "+=") + c, r.animate(s, f, g)), r.queue(function() {
...
(function(e) {
	e.effects.effect.clip = function(t, i) {
		...
		e.effects.save(r, o), r.show(), a = e.effects.createWrapper(r).css({
			overflow: "hidden"
		}), s = "IMG" === r[0].tagName ? a : r, n = s[c](), h && (s.css(c, 0), s.css(p, n / 2)), m[c] = h ? n : 0, m[p] = h ? 0 : n / 2, s.animate(m, {
			queue: !1,
			duration: t.duration,
			easing: t.easing,
			complete: function() {
...
(function(e) {
	e.effects.effect.fold = function(t, i) {
		...
		e.effects.save(n, r), n.show(), a = e.effects.createWrapper(n).css({
			overflow: "hidden"
		}), s = p ? [a.width(), a.height()] : [a.height(), a.width()], d && (u = parseInt(d[1], 10) / 100 * s[h ? 0 : 1]), l && a.css(c ? {
			height: 0,
			width: u
		} : {
			height: u,
			width: 0
		}), g[f[0]] = l ? s[0] : u, v[f[1]] = l ? s[1] : 0, a.animate(g, m, t.easing).animate(v, m, t.easing, function() {
...
(function(e) {
	e.effects.effect.pulsate = function(t, i) {
		var a, s = e(this),
			...
			c = s.queue(),
			p = c.length;
		for ((r || !s.is(":visible")) && (s.css("opacity", 0).show(), d = 1), a = 1; h > a; a++) s.animate({
			opacity: d
		}, u, t.easing), d = 1 - d;
		s.animate({
			opacity: d
...
(function(e) {
	e.effects.effect.puff = function(t, i) {
		...
		s.effect = "size", s.queue = !1, s.complete = i, "effect" !== n && (s.origin = h || ["middle", "center"], s.restore = !0), s.from = t.from || ("show" === n ? {
			height: 0,
			width: 0,
			outerHeight: 0,
			outerWidth: 0
...
(function(e) {
	e.effects.effect.slide = function(t, i) {
		var a, s = e(this),
			...
			u = "up" === h || "left" === h,
			d = {};
		e.effects.save(s, n), s.show(), a = t.distance || s["top" === l ? "outerHeight" : "outerWidth"](!0), e.effects.createWrapper(s).css({
			overflow: "hidden"
